...
int maxPage = products.size()/12 + 1;
...
<div id="container">
	...
	<div id = "login">
		<form action = "LoginServlet" method = "post">
			...
			<input id = "email" type="text" placeholder="email" name="emailLogin"/><br/>
			<label for="password">Password</label>
			<input id = "password" type="password" placeholder="password" name="passwordLogin"/><br/>
	...
	%>
	<p id="userName">Hello,<%=name %>. You can</p>
	<div id="logout">
	...
	<div id="main">
		...
		<div id="product-container">
			...
			%>
				<div id="product">
					<a href="singlehd.html">
						<img src="<%=products.get(i)%>"/>
					</a>
