...
<body>
	...
	<div id="product">
			...
			<a href="ShowInfo?productId=<c:out value="${requestScope.selected_product.id}"></c:out>">
			...
			<c:if test="${sessionScope.client != null}"> <%-- only the logged in clients have this option --%>
				<form action="AddToCartServlet" method="POST">
					<input type="hidden" value="${requestScope.selected_product.model}" name="model_to_add">
