...
<div id="product_properties">
	...
	<form id="properties" action="AddProductServlet" method="POST" >
		...
		<p class="ram_type">
			<input type="text" name="ram_type" id="ram_type" value="enter ram type" />
		</p>
		
		<p class="size">
			<input type="text" name="size" id="size" value="enter ram size" />
		</p>
		
		<p class="type">
			<input type="hidden" name="type" id="type" value="ram" />
		</p>
