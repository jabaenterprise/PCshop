...
<div id="product_properties">
	...
	<form id="properties" action="AddProductServlet" method="POST" >
		<h2>Enter motherboard properties:</h2>	
		<p class="producer">
		...
		<p class="chipset">
			<input type="text" name="chipset" id="chipset" value="enter chipset" />
		</p>
		
		<p class="ram_slots">
			<input type="text" name="ram_slots" id="ram_slots" value="enter ram slots" />
		</p>
		...
		<p class="type">
			<input type="hidden" name="type" id="type" value="mb" />
		</p>
