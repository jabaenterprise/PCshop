...
<div id = "wrapper">
	<div id = "header" >
			<div id="logo">
				<a href = "index.jsp"> <img src="img/PCSHOP.png" width  = 330 height=120 alt = "Logo" title="PCShop"></a>
			</div><!-- end of logo -->
<div class="product">
...
<input type="hidden" name="prodID" value="<c:out value="${requestScope.product.id}"/>"<%System.out.println("form product"+request.getParameter("productId")); %>>
