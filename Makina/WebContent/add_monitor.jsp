...
<div id="product_properties">
	...
	<form id="properties" action="AddProductServlet" method="POST" >
		<h2>Enter monitor properties:</h2>	
		<p class="producer">
		...
		<p class="size">
			<input type="text" name="size" id="size" value="enter size" />
		</p>
		
		<p class="refresh_rate">
			<input type="text" name="refresh_rate" id="refresh_rate" value="enter refresh rate" />
		</p>
		
		<p class="matrix_type">
			<input type="text" name="matrix_type" id="matrix_type" value="enter matrix type" />
		</p>
		
		<p class="type">
			<input type="hidden" name="type" id="type" value="monitor" />
		</p>
