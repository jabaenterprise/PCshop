...
<div id="product_properties">
	...
	<form id="properties" action="AddProductServlet" method="POST" >
		<h2>Enter hard drive properties:</h2>	
		<p class="producer">
		...
		<p class="hd_type">
			<input type="text" name="hd_type" id="hd_type" value="enter hard drive type" />
		</p>
		...
		<p class="capacity">
			<input type="text" name="capacity" id="capacity" value="enter capacity" />
		</p>
				
		<p class="type">
			<input type="hidden" name="type" id="type" value="hd" />
		</p>
